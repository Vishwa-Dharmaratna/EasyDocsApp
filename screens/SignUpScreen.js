...
const SignInScreen=({navigation})=>{
    ...
    const updateFirstNameEntry=(val)=>{
    ...
    const registerHandle=()=>{
        ...
        axios.post('http://vast-atoll-96781.herokuapp.com/users/register',data2)
            .then(response => {
                ...
                <View style={styles.action}>
                    <FontAwesome
                        ...
                        <TextInput
                            ...
                            style={styles.textInput}
                            autoCapitalize="none"
                            onChangeText={(val)=>updateFirstNameEntry(val)}
                        />
